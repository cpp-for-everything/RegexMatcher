...
namespace URLMatcher {
    ...
    class RegexMatcher {
        ...
        template<typename ConstIterator>
        static Container<std::pair<Limits, size_t>>::const_iterator processLimit(const SubTree<Node<UniqueMatchDataPtr, symbol_t>>&, SubTree<Node<UniqueMatchDataPtr, symbol_t>>&, UniqueMatchDataPtr, ConstIterator&);
    ...
    public:
         ...
         */
        template<typename Iterable>
        std::vector<UniqueMatchDataPtr> match(Iterable str) const {
